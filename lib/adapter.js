    ...
    async *streamOnce(options, attempt, stepState) {
        ...
        try {
            ...
            try {
                 ...
                 */
                const forwardInsertion = (insertion) => {
                    const queuePrompt = () => {
                    ...
                    void conn.request('session/steer', { sessionId: acpSessionId, contentBlocks: [{ type: 'text', text: insertion.text }] }, 20_000).then(res => { if (res?.steered !== true)
