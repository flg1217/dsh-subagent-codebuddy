 ...
 */
export function markSelfInitiatedCompaction(sessionId, at) {
 ...
 */
export function isSelfInitiatedCompaction(sessionId, summaryAt, now) {
...
/** 测试用:清掉全部标记。 */
export function resetSelfInitiatedCompactionsForTests() {
    selfInitiated.clear();
}
