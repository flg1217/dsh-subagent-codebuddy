 ...
 * 概率也最低。
 */
export declare const SELF_INITIATED_TTL_MS: number;
/**
 ...
 */
export declare function markSelfInitiatedCompaction(sessionId: string, at: number): void;
/**
 ...
 */
export declare function isSelfInitiatedCompaction(sessionId: string, summaryAt: number, now: number): boolean;
/** 测试用:清掉全部标记。 */
export declare function resetSelfInitiatedCompactionsForTests(): void;
