    ...
    async runAttempt() {
        ...
        try {
            ...
            for (let offset = 0; offset < bridgeTools.length; offset += BRIDGE_BATCH) {
                void announceDelegateTools((method, params) => conn.request(method, params, this.to.firstMs), this.acpSessionId, bridgeTools.slice(offset, offset + BRIDGE_BATCH)).catch(() => { });
            }
