...
export function listCodebuddyModels(command, prefixArgs) {
    ...
    if (ids.length === 0)
        return 'The CodeBuddy CLI listed no supported models.';
...
export function registerCodebuddyModelsTool(ctx, options) {
    ctx.tools.register(defineTool({
        ...
        description: 'List the model ids currently supported by the CodeBuddy CLI. Call this before delegating when you want a '
