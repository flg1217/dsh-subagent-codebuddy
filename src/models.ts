...
export function parseCodebuddyModelIds(helpText: string): string[] {
 ...
 */
export function listCodebuddyModelIdsAsync(
  command: string,
  prefixArgs: string[],
  timeoutMs = 15_000,
): Promise<string[]> {
...
export function registerCodebuddyModelsTool(
  ...
  return ctx.tools.register(defineTool({
    ...
    description:
      'List the model ids currently supported by the CodeBuddy CLI. The generic subagent tool also accepts '
